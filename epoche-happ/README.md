...
You'll have the `epoche-happ.webhapp` in `workdir`. This is what you should distribute so that the Holochain Launcher can install it.

You will also have its subcomponent `epoche-happ.happ` in the same folder`.
